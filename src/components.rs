use crate::storage::{entity_allocator::EntityAllocator, component_storage::ComponentStorage};

use self::{celestial_body_component::CelestialBodyComponent, mass_component::MassComponent, parent_component::ParentComponent, position_component::PositionComponent, trajectory_component::TrajectoryComponent, velocity_component::VelocityComponent, name_component::NameComponent};
