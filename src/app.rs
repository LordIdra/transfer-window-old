...
impl App {
    ...
    fn init_objects(&mut self) {
        ...
        let moon = Object::new("moon".to_string(), Some(earth.clone()), vec2(3.633e8, 0.0), vec2(0.0, -0.582e3), 7.346e22, 1.738e6, Rgba::from_rgba_unmultiplied(0.3, 0.3, 0.3, 1.0));
        ...
        self.camera.lock().unwrap().follow(moon.clone());
